...
import com.zhenl.launcher.LauncherUtilsKt;
import com.zhenl.launcher.iconpack.AdaptiveIconCompat;
import com.zhenl.launcher.iconpack.LauncherIconProvider;
...
public class AdaptiveIconGenerator {
    ...
    public AdaptiveIconGenerator(Context context, @NonNull Drawable icon) {
        ...
        LauncherPreferences prefs = LauncherUtilsKt.getLauncherPrefs(context);
    ...
    private void loop() {
        if (Utilities.ATLEAST_OREO && shouldWrap) {
            ...
            if (icon instanceof AdaptiveIconCompat) {
                ...
                if (!LauncherUtilsKt.isSingleColor(aid.getBackground(), Color.WHITE)) {
                    onExitLoop();
                    return;
                }
    ...
    private void initTmpIfNeeded() {
        if (tmp == null) {
            tmp = LauncherIconProvider.getAdaptiveIconDrawableWrapper(context);
